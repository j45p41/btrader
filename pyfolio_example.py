...
def parse_args(args=None):
    ...
    parser.add_argument('--data0', required=False,
                        default='C:/Users/Jaspal/OneDrive/Financial Stuff/btrader_git/datas/yhoo-1996-2015.txt',
                        help='Data to be read in')

    parser.add_argument('--data1', required=False,
                        default='C:/Users/Jaspal/OneDrive/Financial Stuff/btrader_git/datas/orcl-1995-2014.txt',
                        help='Data to be read in')

    parser.add_argument('--data2', required=False,
                        default='C:/Users/Jaspal/OneDrive/Financial Stuff/btrader_git/datas/nvda-1999-2014.txt',
                        help='Data to be read in')
